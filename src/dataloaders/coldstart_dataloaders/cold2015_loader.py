...
TEST_DATASET_DIR = "../datasets/coldstart_datasets/coldstart1_2015_testdatasets.csv"

class CODL2015_TRAIN(Dataset):
...
class CODL2015_TEST(Dataset):
    def __init__(self, dataset_dir=TEST_DATASET_DIR) -> None:
        super().__init__()
